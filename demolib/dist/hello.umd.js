(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('axios'), require('react')) :
    typeof define === 'function' && define.amd ? define(['axios', 'react'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Cee = factory(global.axios, global.React));
    ...
    ***************************************************************************** */
    ...
    var handleError = function (statusCode) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (statusCode === 401) {
    ...
    axiosInstance.interceptors.response.use(function (response) {
        var _a;
        handleError((_a = response === null || response === void 0 ? void 0 : response.data) === null || _a === void 0 ? void 0 : _a.code);
        return response;
    }, function (error) {
        var _a;
        handleError((_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.status);
